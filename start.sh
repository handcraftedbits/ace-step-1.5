...
acestep --server-name 0.0.0.0 --port 7860 --init_service false --config_path "$CONFIG_PATH" --lm_model_path "$LM_MODEL_PATH" --backend pt 2>&1 | tee /app/outputs/gradio.log &
GRADIO_PID=$!
